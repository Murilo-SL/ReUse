...
// ong_configuracoes.js - ATUALIZADO com funcionalidade de temas
...
function loadTheme() {
    ...
    // Atualizar o seletor de tema na aba Preferências
...
function applyTheme(theme) {
    ...
    body.classList.remove('night-mode', 'light-mode', 'auto-mode');
...
// Função para atualizar o seletor de tema
...
function selectTheme(element) {
    ...
    showToast(`Tema ${themeName} selecionado`, "success");
}

// Função para alternar o tema (botão no header)
...
// Função para detectar mudanças na preferência do sistema (apenas para tema automático)
...
function resetPreferences() {
    // Redefinir tema para claro
    applyTheme('light');
    updateThemeSelector('light');
    
    // Redefinir outras preferências aqui...
...
document.addEventListener("DOMContentLoaded", function() {
    ...
    // Iniciar observação de mudanças no tema do sistema
    watchSystemTheme();
    
    // Configurar evento do botão de tema no header
